...
do
	...
	-- turn netrw off to avoid conflicts with nvim-tree
...
do
	...
	require("telescope").setup({
		...
		defaults = {
			mappings = {
				-- close immediately on <Esc> instead of dropping into
				-- Telescope's normal mode first (which needs a 2nd <Esc>)
...
do
	...
	-- Spell checking: built-in checker, per-project and per-user word lists.
